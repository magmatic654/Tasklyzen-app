...
(function exposeTasklyzenDom(global) {
    ...
    const analytics = {
        ...
        analyticsPanelTitle: byId('analytics-panel-title'),
        analyticsTrendTitle: byId('performance-trend-title'),
        analyticsChartKey: byId('analytics-chart-key'),
        ...
        analyticsSummaryContext: byId('analytics-summary-context'),
